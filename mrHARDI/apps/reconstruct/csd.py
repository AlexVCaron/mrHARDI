...
from mrHARDI.traits.csd import (CSDAlgorithm,
                                     TournierResponseAlgorithm)
from mrHARDI.config.csd import (FiberResponseConfiguration,
                                     CSDConfiguration)
...
class CSD(mrHARDIBaseApplication):
...
class FiberResponse(mrHARDIBaseApplication):
